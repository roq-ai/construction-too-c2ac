  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless tool rental with Construction Tool Rental, where individual customers connect with multiple outlets for their construction needs."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless tool rental with Construction Tool Rental, where individual customers connect with multiple outlets for their construction needs.`}
            </Text>
            <Box
